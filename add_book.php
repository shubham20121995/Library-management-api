...
class User {
    ...
    public function add_book($book_id,$author,$book_name,$publication,$edition,$no_of_copies,$date_pur,$price)
    {
        $query = "insert into all_books values('$book_id','$author','$book_name','$publication','$edition','$no_of_copies','$date_pur','$price')";
...
if(isset($_POST['book_id'],$_POST['author'],$_POST['book_name'],$_POST['publication']
    ...
    if(!empty($book_id) && !empty($book_name) && !empty($author) && !empty($publication)
        ...
        $user->add_book($book_id,$author,$book_name,$publication,$edition,$no_of_copies,$date_pur,$price);
